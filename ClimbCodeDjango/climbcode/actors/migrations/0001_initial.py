    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Instituto', 'Instituto'), ('Academia', 'Academia')], default='Instituto', max_length=11)),
                ('teachingType', models.CharField(choices=[('Público', 'Público'), ('Privado', 'Privado')], default='Público', max_length=20, verbose_name='Teaching Type')),
                ('identificationCode', models.CharField(help_text='Requerido. CIF para escuelas; Código de Centro para academías.', max_length=9, null=True, validators=[django.core.validators.RegexValidator(message='El código de identificación debe estar compuesto de 8 dígitos o 9 dígitos.', regex='^(\\d{8,9})$')], verbose_name='CIF or Center Code')),
                ('isPayed', models.BooleanField(default=False, verbose_name='Pagada')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('actor_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='actors.Actor')),
                ('dni', models.CharField(help_text='Requerido. 8 dígitos y una letra.', max_length=9, null=True, validators=[django.core.validators.RegexValidator(message='El formato introducido es incorrecto.', regex='^([0-9]{8})([TRWAGMYFPDXBNJZSQVHLCKE])$')], verbose_name='D.N.I.')),
                ('school_s', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='actors.School', verbose_name='School')),
            ],
            options={

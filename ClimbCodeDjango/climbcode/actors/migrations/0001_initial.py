    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dni', models.CharField(help_text='Requerido. 8 dígitos como máximo.', max_length=8, null=True, validators=[django.core.validators.RegexValidator(message='El formato introducido es incorrecto.', regex='^(\\d{3})(\\-)(\\d{3})(\\-)(\\d{3})$')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificationCode', models.CharField(help_text='Requerido. 8 dígitos como máximo.', max_length=8, null=True, validators=[django.core.validators.RegexValidator(message='El formato introducido es incorrecto.', regex='^(\\d{8})$')])),
            ],
            options={
